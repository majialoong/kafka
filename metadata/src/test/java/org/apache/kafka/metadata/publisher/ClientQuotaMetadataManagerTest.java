...
public class ClientQuotaMetadataManagerTest {
    ...
    public void testUserClientQuotaUpdateAndRemoval(String key) {
        ...
        assertSame(expectedEntity, userClientQuotaUpdates.get(0).entity());
    ...
    public void testDefaultUserClientEntityIsPreserved(String entityType) {
        ...
        assertEquals(List.of(new UserClientQuotaUpdate(REQUEST_PERCENTAGE_OVERRIDE_CONFIG,
            new ClientQuotaEntity(expectedEntries), Optional.of(Quota.upperBound(10)))), userClientQuotaUpdates);
        assertTrue(ipQuotaUpdates.isEmpty());
    }
    ...
    public void testMixedDefaultAndExplicitUserClientEntityIsPreserved() {
        ...
        assertEquals(List.of(new UserClientQuotaUpdate(PRODUCER_BYTE_RATE_OVERRIDE_CONFIG,
            new ClientQuotaEntity(expectedEntries), Optional.of(Quota.upperBound(100)))), userClientQuotaUpdates);
        assertTrue(ipQuotaUpdates.isEmpty());
    }
    ...
    public void testUserClientCallbackFailureDoesNotStopRemainingUpdates() {
        ...
        BiConsumer<ClientQuotaEntity, Optional<Quota>> userClientQuotaUpdater = (entity, quota) -> {
    ...
    private Map<String, BiConsumer<ClientQuotaEntity, Optional<Quota>>> userClientQuotaUpdaters() {
        Map<String, BiConsumer<ClientQuotaEntity, Optional<Quota>>> userClientQuotaUpdaters = new HashMap<>();
    ...
    private record UserClientQuotaUpdate(String key, ClientQuotaEntity entity, Optional<Quota> quota) { }
