...
public class ClientQuotaMetadataManagerTest {
    private final Map<String, BiConsumer<UserClientQuotaEntity, OptionalDouble>> userClientQuotaUpdaters = Map.of(
        CONSUMER_BYTE_RATE_OVERRIDE_CONFIG, mock(),
        PRODUCER_BYTE_RATE_OVERRIDE_CONFIG, mock(),
        REQUEST_PERCENTAGE_OVERRIDE_CONFIG, mock(),
        CONTROLLER_MUTATION_RATE_OVERRIDE_CONFIG, mock()
    );
    private final BiConsumer<Optional<InetAddress>, OptionalInt> ipQuotaUpdater = mock();
