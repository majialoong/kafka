...
public sealed interface QuotaEntity {
     ...
     */
    static UserClientQuotaEntity userQuotaEntity(String user) {
     ...
     */
    static UserClientQuotaEntity clientIdQuotaEntity(String clientId) {
     ...
     */
    static UserClientQuotaEntity userClientQuotaEntity(String user, String clientId) {
