...
public class QuotaFactory {
    ...
    public record QuotaManagers(ClientQuotaManager fetch,
        ...
        public Map<String, BiConsumer<ClientQuotaEntity, Optional<Quota>>> userClientQuotaUpdaters() {
            return Map.of(
        ...
        private static BiConsumer<ClientQuotaEntity, Optional<Quota>> userClientQuotaUpdater(ClientQuotaManager manager) {
            return (entity, quota) -> {
